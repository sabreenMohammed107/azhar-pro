...
class RequestStatusController extends Controller
{
     ...
     * @return void
     */
    public function __construct(Requests_status $object)
    {
        $this->middleware('is_admin');
        $this->object = $object;
        $this->viewName = 'admin.requestStatus.';
        $this->routeName = 'requestStatus.';
    ...
    {
        $rows=Requests_status::orderBy("created_at", "Desc")->get();
