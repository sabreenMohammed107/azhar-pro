...
class EducationStatusController extends Controller
{
     ...
     * @return void
     */
    public function __construct(Education_status $object)
    {
        $this->middleware('is_admin');
        $this->object = $object;
        $this->viewName = 'admin.educationStatus.';
        $this->routeName = 'educationStatus.';
    ...
    {
        $rows = Education_status::orderBy("created_at", "Desc")->get();
