...
<div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('{{ asset('webassets/images/bg_1.jpg')}}')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0">Accomodation Request</h2>
...
<div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Accomodation Request</span>
      </div>
    </div>
...
<div id="alertDiv" class="alert alert-info alert-block">
	<button type="button" id="alertClose" class="close" data-dismiss="alert">×</button>
        ...
        <div class="container">
			...
			<hr class="hr-yellow" />
            <form action="{{url('/student/update-accomodate-request')}}" method="POST" enctype="multipart/form-data" >
                {{ csrf_field() }}
...
?>
            ...
            <!-- new Data -->
            <br />
            <h2><i class="flaticon-diploma"></i> Accomodation Request</h2>
			<hr class="hr-yellow" />
			<div class="row">
            <div class="col-md-6 form-group">
					<label for="cyear">Education Year</label>
