    ...
    <div class="col-md-12">
        <div class="ms-panel">
            ...
            <div class="ms-panel-body col-md-6 col-md-offset-2">
                ...
                <form action="{{route('accomodationRequest.update',$row->id)}}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
...
<button data-toggle="modal" data-target="#cancle" type="button" class="btn btn-primary waves-effect waves-light mg-b-15">Back</button>
                      ...
                      <div class="col-md-12">
                              <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      <input type="text" id="newTitle" readonly name="{{$row->request_no}}" value="{{$row->student->user->name ?? ''}}" class="form-control"
                                         placeholder=" {{$row->request_no}}">
                                  </div>
                              </div>
                      </div>
                      <div class="col-md-12">
