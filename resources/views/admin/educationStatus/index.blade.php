...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Education Status </li>
    </ol>
  </nav>
							...
							<td>{{ $index +1 }}</td>
                                      ...
                                      >edit</a>
                                        <a href="#" onclick="destroy('this Education','{{$row->id}}')" class="btn d-inline-block btn-danger">delete</a>
                                         <form id="delete_{{$row->id}}" action="{{ route('educationStatus.destroy', $row->id) }}"  method="POST" style="display: none;">
									@csrf
									@method('DELETE')
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="ms-auth-container row no-gutters">
          ...
          <form action="{{route('educationStatus.update',$row->id)}}" method="POST">
                @method('PUT')
				  @csrf
    ...
    <div class="modal-dialog modal-lg " role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="ms-auth-container row no-gutters">
              <div class="col-12 p-3">
                  <form action="{{route('educationStatus.store')}}" method="POST">
                  @csrf
                      <div class="ms-auth-container row">
