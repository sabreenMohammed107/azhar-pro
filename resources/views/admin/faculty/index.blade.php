					...
					<table id="courseEval" class="dattable table table-striped thead-dark  w-100">
						...
						@foreach($rows as $index => $row)
							...
							<td>{{ $index +1 }}</td>
                                      ...
                                      >edit</a>
                                        <a href="#" onclick="destroy('this Faculty','{{$row->id}}')" class="btn d-inline-block btn-danger">delete</a>
                                         <form id="delete_{{$row->id}}" action="{{ route('faculty.destroy', $row->id) }}"  method="POST" style="display: none;">
									@csrf
									@method('DELETE')
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="ms-auth-container row no-gutters">
          ...
          <form action="{{route('faculty.update',$row->id)}}" method="POST">
                @method('PUT')
				  @csrf
