					...
					<table id="courseEval" class="dattable table table-striped thead-dark  w-100">
						...
						@foreach($rows as $index => $row)
							...
							<td>{{ $index +1 }}</td>
                                      ...
                                      >edit</a>
                                        <a href="#" onclick="destroy('this Building','{{$row->id}}')" class="btn d-inline-block btn-danger">delete</a>
                                         <form id="delete_{{$row->id}}" action="{{ route('building.destroy', $row->id) }}"  method="POST" style="display: none;">
									@csrf
									@method('DELETE')
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="ms-auth-container row no-gutters">
          ...
          <form action="{{route('building.update',$row->id)}}" method="POST">
                @method('PUT')
				  @csrf
                  <div class="ms-auth-container row">
                      ...
                      <div class="col-md-12">
                          <div class="form-group">
                              ...
                              <div class="input-group">
                                  <input type="text" id="newTitle" name="address" value="{{$row->address}}" class="form-control"
                                     placeholder="address">
                              </div>
                          </div>
                      </div>
                  ...
                  @csrf
                      <div class="ms-auth-container row">
                          ...
                          <div class="form-group">
                              <label  >{{ __('Address') }}</label>
                              <div class="input-group">
                                  <input type="text" id="newTitle" name="address"  class="form-control"
                                     placeholder="address">
                              </div>
                          </div>
                      </div>
